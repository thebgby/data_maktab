...
from scripts.extract import pnl_extract, maktab_royxat_extract, maktab_kassa_extract
from scripts.load import pnl_load, maktab_royxat_load, maktab_kassa_load
from config import pnl, maktab_royxat, maktab_kassa
